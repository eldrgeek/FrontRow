...
const BUILDINGS: Building[] = [
  ...
  { route: 'library',    label: 'The Library',     who: 'Mem · Levin · The Wall',    shape: 'temple',  x: 6,  y: 6,  w: 36, h: 16, vibe: 'archive' },
  { route: 'tower',      label: 'The Tower',        who: 'Dee',                        shape: 'tower',   x: 46, y: 4,  w: 7,  h: 22, vibe: 'orchestrator' },
  { route: 'studio',     label: 'The Studio',       who: 'Drew · Riff',                shape: 'long',    x: 57, y: 6,  w: 28, h: 9,  vibe: 'words' },
  { route: 'booth',      label: 'The Booth',        who: 'Sona',                       shape: 'octagon', x: 88, y: 6,  w: 10, h: 12, vibe: 'audio' },
  // Row 2 (y 32-44, labels at 46-50)
  { route: 'situation',  label: 'Situation',        who: 'Locke',                      shape: 'rect',    x: 57, y: 32, w: 18, h: 10, vibe: 'security' },
  { route: 'workshop',   label: 'The Workshop',     who: 'Ren',                        shape: 'rect',    x: 78, y: 32, w: 9,  h: 10, vibe: 'pixels' },
  { route: 'forge',      label: 'The Forge',        who: 'Cal · Skip · Sol',           shape: 'hex',     x: 90, y: 32, w: 10, h: 10, vibe: 'process' },
  // Row 3 (y 56-70, labels at 72-76)
  { route: 'garden',     label: 'The Garden',       who: 'Mae · Kelp',                 shape: 'plots',   x: 6,  y: 56, w: 18, h: 12, vibe: 'community' },
  { route: 'cafe',       label: 'The Cafe',         who: 'Greta · open seating',       shape: 'round',   x: 28, y: 56, w: 16, h: 12, vibe: 'pairs' },
  { route: 'forum',      label: 'The Forum',        who: 'Opie · all rotating',        shape: 'round',   x: 47, y: 56, w: 13, h: 12, vibe: 'meetings' },
  { route: 'greenhouse', label: 'The Greenhouse',   who: 'Tilt · Rally',               shape: 'green',   x: 64, y: 56, w: 20, h: 12, vibe: 'growth' },
  { route: 'switchboard',label: 'Switchboard',      who: 'Herm',                       shape: 'cross',   x: 88, y: 56, w: 10, h: 12, vibe: 'routing' },
  // Row 4 (y 80-94)
  { route: 'stage',      label: 'The Stage',        who: 'Riff',                       shape: 'amorph',  x: 3,  y: 80, w: 19, h: 14, vibe: 'music' },
  { route: 'lab',        label: 'The Lab',          who: 'Yeshie',                     shape: 'hex',     x: 25, y: 80, w: 18, h: 14, vibe: 'automation' },
  { route: 'guesthouse', label: 'The Guest House',  who: 'Cora · Penn · Vera · Coach · Dewey', shape: 'rect', x: 46, y: 80, w: 24, h: 14, vibe: 'client-facing' },
  { route: 'atrium',     label: 'The Atrium',       who: 'the team · directory',       shape: 'round',   x: 73, y: 80, w: 26, h: 14, vibe: 'org chart' },
];
  ...
  return (
    <section className="campus">
      ...
      <div className="campus-legend">
        ...
        <span><i className="lg lg-routing" /> routing</span>
        <span><i className="lg lg-music" /> music</span>
        <span><i className="lg lg-automation" /> automation</span>
        <span><i className="lg lg-client" /> client-facing</span>
        <span><i className="lg lg-atrium" /> org chart</span>
      </div>
    </section>
  );
}
